...
printHeader :: IO ()
printHeader = print $ PP.bold $ PP.black $ PP.ondullwhite $ PP.fill 15 (PP.text "Product") PP.<+> PP.fill 6 (PP.text "Price") PP.<+> PP.fill 23 (PP.text "Date")

prettyPrintPurchases :: [Purchase] -> IO ()
prettyPrintPurchases ps = print $ PP.vcat $ fmap (\p ->
